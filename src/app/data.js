const data = [
  {
    ...
    itemCopy:
      "Learn about TechViz, a revolutionary tool for the visually impaired.  TechViz is designed to be intuitive and effective, making it an essential tool for improving the quality of life for blind individuals. With its advanced features, TechViz provides unparalleled support and confidence in navigating various environments.",
    itemImage: "/images/Untitled.png",
  },
  {
    itemName: "TechViz Band",
    itemCopy:
      "Discover the lightweight, wearable wristband that offers full functionality. TechViz Band: A small, lightweight wristband designed for daily use, offering full functionality without compromising on comfort.",
    itemImage: "/images/band1.png",
  },
  {
